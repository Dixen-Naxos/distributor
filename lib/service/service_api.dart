...
class ServiceAPI {
  ...
  Future<Distributor> getDistributor() async {
    final response = await dio.get('http://146.59.237.29:7790/distributors/477b0e36-e58e-4596-a31f-a6801fcd2c31');
    return Distributor.fromJson(jsonDecode(response.toString()));
  }

  Future<void> buyProduct(String user_id, String product_id) async {
    await dio.put('http://146.59.237.29:7790/distributors/477b0e36-e58e-4596-a31f-a6801fcd2c31/buyProduct/' + product_id + '/' + user_id);
  }

  Future<User> getUser(String user_id) async {
    final response = await dio.get("http://146.59.237.29:7790/users/" + user_id);
